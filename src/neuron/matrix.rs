...
impl Matrix {
    ...
    pub fn cr_randomize_net(v_count: Int, h_count: Int) -> Result<Matrix> {
        ...
        for _ in 0..(v_count * h_count) {
            ...
            // Берём слой проекции соответствующий незаполненному слою горизонтальной проекции
